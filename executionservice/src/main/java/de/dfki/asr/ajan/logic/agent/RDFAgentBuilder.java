...
public class RDFAgentBuilder extends AgentBuilder {
    ...
    protected LocalServicesBeliefBase servicesBeliefs;
    protected LocalAgentsBeliefBase localAgentsBeliefs;
	...
	inferencing = Inferencing.NONE;
        ...
        LocalServicesBeliefBase servicesBeliefsInner = servicesBeliefs;
        LocalAgentsBeliefBase localAgentsBeliefsInner = localAgentsBeliefs;
        AgentBeliefBase beliefs = createAgentKnowledge(template);        
        //return new Agent(url, name, template, initialBehavior, finalBehavior, behaviors, beliefs, servicesBeliefsInner, localAgentsBeliefsInner, events, endpoints, connections);
        return new Agent(url, id, template, initialBehavior, finalBehavior, behaviors, manageTDB, beliefs, servicesBeliefsInner, localAgentsBeliefsInner, events, endpoints, connections);
    }
    ...
    protected AgentBeliefBase createAgentKnowledge(final Resource agentTemplateRsc) {
        ...
        //servicesBeliefs = new LocalServicesBeliefBase(tdbManager.createAgentServiceKnowledge(name, Inferencing.NONE));
        //localAgentsBeliefs = new LocalAgentsBeliefBase(tdbManager.createLocalAgentsKnowledge(name, Inferencing.NONE));
        AgentBeliefBase beliefs = new AgentBeliefBase(tdbManager.createAgentTDB(id,manageTDB,Inferencing.NONE));
        servicesBeliefs = new LocalServicesBeliefBase(tdbManager.createAgentServiceKnowledge(id,manageTDB,Inferencing.NONE));
        localAgentsBeliefs = new LocalAgentsBeliefBase(tdbManager.createLocalAgentsKnowledge(id,manageTDB,Inferencing.NONE));
