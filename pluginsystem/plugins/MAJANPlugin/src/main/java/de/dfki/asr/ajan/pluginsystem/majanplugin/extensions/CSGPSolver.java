 ...
 */
@Extension
@RDFBean("bt:CSGPSolver")
public class CSGPSolver extends AbstractTDBLeafTask implements NodeExtension, TreeNode{
    
    private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(CSGPSolver.class);
    ...
    public Resource getType() {
        return MAJANVocabulary.CsgpSolverType;
    }
           
    @Override
    public String toString() {
        return "CSGPSolver (" + this.getUrl() + ")";
    }
    
    @Override
    public void end() {
        LOG.info("CSGPSolver (" + getStatus() + ")");
    }
    ...
    private boolean csgpSolved() throws URISyntaxException, CSGPSolverInputException {
        String solverName;
        int numOfAgents;
