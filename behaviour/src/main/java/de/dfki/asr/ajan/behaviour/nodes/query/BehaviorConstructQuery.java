...
//                Model myModel=resultModel.filter(null, BTVocabulary.HAS_RDF_CONTEXT,null);
//                System.out.println("55----" + myModel.size());
//                for(Resource r:myModel.subjects()){
//                    System.out.println("66---"+r.stringValue());
//                }
